...
When the wallet is opened, it begins syncing automatically. If this is the first time syncing the wallet or if you haven't opened the wallet in a few weeks, you can use a [bootstrap](#bootstrap) to sync the wallet faster.
...
??? warning "Check Peer Connection Count; Fix No Peers Issue"
	...
	1. If the Internet connection on your staking computer may have
       ...
       in your
       [Blocknet Data Directory](backup-restore.md#data-directory):
	   ```
	   bantime=180
	   ```
...
1. [Install the wallet](installation.md) or update to the [latest release](https://blocknet.org/downloads).
1. Download the [latest bootstrap files](https://github.com/blocknetdx/blocknet-blockchain-bootstrap/releases/latest).
...
1. Read more about syncing [above](#synchronization).
