...
??? example "Check using the redesigned wallet"
	...
	1. If you are on a fork, follow the [Bootstrap guide](syncing.md#bootstrap) to resync your chain. Make sure to follow all the directions and remove the listed files.
...
## How to Unfork
If you are on a fork, follow the [Bootstrap guide](syncing.md#bootstrap) to resync your chain. Make sure to follow all the directions and remove the listed files.
