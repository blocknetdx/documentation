...
wallet](installation.md#redesigned-vs-classical-guiqt-wallet),
there is a Coin Control feature which allows you to explore the
[addresses](../resources/glossary.md#address) and [inputs](../resources/glossary.md#input) where funds are
stored in your wallet. This feature also allows you to *lock* specific
inputs to prevent them from being spent.

1. Select *Window->Coin Control* to display the [addresses](../resources/glossary.md#address) and [inputs](../resources/glossary.md#input) where funds are stored in your
wallet:
...
1. After right-clicking on an *input*, select *Lock unspent* to lock
   ...
   Funds](send-funds.md), by a [BlockDX](../blockdx/introduction.md) transaction,
   or by a call to the *servicenodecreateinputs* method
   (sometimes called during [Collateral Wallet Setup](../service-nodes/setup.md#collateral-wallet-setup)).
